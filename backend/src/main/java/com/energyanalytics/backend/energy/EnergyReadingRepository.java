...
public interface EnergyReadingRepository
        ...
        List<EnergyReading> findByDeviceIdAndTimestampBetweenAndTotalActEnergyKwhIsNotNullOrderByTimestampAsc(
                        Long deviceId,
                        Instant start,
                        Instant end);
        ...
        Optional<EnergyReading> findTopByDeviceIdOrderByTimestampDesc(Long deviceId);
}
